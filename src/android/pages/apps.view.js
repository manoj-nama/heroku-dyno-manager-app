...
export default class AppsPage extends Component {
	...
	componentWillMount() {
		...
		BackAndroid.addEventListener('hardwareBackPress', self.backButtonHandler.bind(self));
	}

	backButtonHandler() {
		this.props.navigator.pop();
		BackAndroid.removeEventListener('hardwareBackPress', this.backButtonHandler);
		return true;
	}
